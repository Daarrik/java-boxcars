...
public class Boxcars {
    ...
    public void turn(boolean computer) {
        ...
        // If computer is true, print out "Computer's turn: ", otherwise printout humanName + "'s turn:'"
        if(computer)
        ...
        if(multiplier != 1) {
            System.out.println("\t\tSnake Eyes cause " + turnScore + " points to become " + turnScore * multiplier + " points!");
